...
export const CONTACT = {
  ...
  address: ['PYVOT office, Unit 1505, 15th Floor', 'Ergo Tower, Block EP & GP, Plot A1-4', 'Street No. 23, GP Block, Sector V', 'Salt Lake, Bidhannagar', 'Kolkata – 700091'],
  maps: 'https://www.google.com/maps/search/?api=1&query=Unit+1505+15th+Floor+Ergo+Tower+Block+EP+GP+Plot+A1-4+Street+23+GP+Block+Sector+V+Salt+Lake+Bidhannagar+Kolkata+700091',
}
